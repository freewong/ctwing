...
func SaasQueryRule(appKey string, appSecret string, productId string, ruleId string, pageNow string, pageSize string) (*http.Response, error) {
	...
	return core.SendAepHttpRequest(path, headers, param, "", version, application, key, "GET")
}
...
//参数pageSize: 类型long, 参数可以为空
//  描述:
func GetWarnUsers(appKey string, appSecret string, pageNow string, pageSize string) (*http.Response, error) {
